...
open browser     [Arguments]        ${server_url}       ${browser} 
    ...
    Run Keyword If  '${device}'=='iPhone8Chrome'        open application	    http://127.0.0.1:4723/wd/hub        platformName=iOS	    deviceName=FX DMS PMO ’s iPhone		platformVersion=13.3		udid=0dc1d871a25ffcffe62eb09ea7e7649f83747968 	    xcodeOrgId=SZRB8P2RU8		newCommandTimeout=360      bundleId=com.google.chrome.ios 
