...
open browser     [Arguments]        ${server_url}       ${browser} 
    ...
    #${status}=      Run keyword and return status       Open Application     http://127.0.0.1:4723/wd/hub       deviceName=iPhone 8      platformName=iOS         platformVersion=13.4      browserName=safari      startIWDP=true      newCommandTimeout=600       xcodeSigningId=iPhone Developer     automationName=XCUITest       
    #Run Keyword If  '${status}'=='False'     open browser       ${server_url}       ${browser}
    Run Keyword If  '${device}'=='iPhone8Emulator'        Open Application     http://127.0.0.1:4723/wd/hub       deviceName=iPhone 8      platformName=iOS         platformVersion=13.4      browserName=safari      startIWDP=true      newCommandTimeout=600       xcodeSigningId=iPhone Developer     automationName=XCUITest 
