...
open browser     [Arguments]        ${server_url}       ${browser} 
    ...
    Run Keyword If  '${device}'=='iPhone8Emulator'        open application	    http://127.0.0.1:4723/wd/hub        browserName=${browser}	        platformName=iOS	    deviceName=FX DMS PMO ’s iPhone		platformVersion=13.3		udid=0dc1d871a25ffcffe62eb09ea7e7649f83747968 	    xcodeOrgId=SZRB8P2RU8		newCommandTimeout=360
