...
open browser     [Arguments]        ${server_url}       ${browser} 
    ...
    ${status}=      Run keyword and return status       Open Application     http://127.0.0.1:4723/wd/hub       deviceName=Pixel2      platformName=Android         platformVersion=10      browserName=${browser}        
